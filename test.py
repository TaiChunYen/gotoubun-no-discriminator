...
parser.add_argument("--model", type=str, default='./model-160.pkl', help="model")
...
resnext = models.resnext50_32x4d(num_classes=opt.n_classes).cuda()
resnext.load_state_dict(torch.load(opt.model))
resnext.eval()
